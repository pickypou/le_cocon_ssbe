              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.center, // Aligner le texte au centre
                    child: Text(
                      'A l\'interieur de ce bâtiment, il y a deux partie disctintes, mais tout compte fait pas si disctintes que ça, où nos deux professionnels vous accueillent du lundi au samedi',
                      style: textStyleText(context).copyWith(
                          height: 1.5, // Ajustez la hauteur de ligne ici
                          fontSize: calculatedFontSize),
                      textAlign:
